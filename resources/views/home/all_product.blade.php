...
<html>
   ...
   <div style="padding-left: 20%;">
        ...
        <div>
            ...
            <p>{{$comment->comment}}</p>
            <br>
            <a style="color: blue;" href="javascript::void(0);" onclick="reply(this)" data-Commented="{{$comment->id}}">Reply</a>
      ...
      <script type="text/javascript">
         ...
         {
            document.getElementById('commentId').value=$(caller).attr('data-Commented');
